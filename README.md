...
Configuration for mpv on multiple platforms, based on the following guides:
...
- [stax76/mpv-scripts](https://github.com/stax76/mpv-scripts)
...
- [nnedi3 nns128 win8x4](https://github.com/bjin/mpv-prescalers)
